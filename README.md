...
| :credit_card:[Customer Shopping Behavior Analysis](https://github.com/jasondo-da/shopping_behavior_analysis) | Data Cleaning, Data Wrangling, Data Mining, Data Visualization, Exploratory Data Analysis, Customer Analysis, Geographic Information Systems | Pandas, Matplotlib, Seaborn, Folium, GeoPy, requests | The marketing team from a clothing apparel business is asking for recommendations on current customer behavior, improving the business processes, and growing the customer base. |
