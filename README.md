...
| :hamburger:[Fast Food Marketing Campaign A/B Test](https://github.com/jasondo-da/Fast_Food_Marketing_Campaign_AB_Test) | data cleaning, hypothesis testing, A/B testing, data visualization | Pandas, NumPy, SciPy, Matplotlib, Seaborn | In Progress |
