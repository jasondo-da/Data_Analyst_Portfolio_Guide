...
| :tv:[Netflix Financial Analysis](https://github.com/jasondo-da/NFLX_Financial_Analysis) |  Data Cleaning, Data Wrangling, Data Visualization, Financial Analysis, Vertical Analysis | Pandas, NumPy, yfinance, Matplotlib, Seaborn | This project analyzes Netflix’s income statement and lists each line item as a percentage of the total operational revenue to explore more easily how effectively Netflix achieves its financial goals and compares it to prior years' performances. |
...
| :hamburger:[Fast Food Marketing Campaign A/B Test](https://github.com/jasondo-da/Fast_Food_Marketing_Campaign_AB_Test) | Data Cleaning, Data Wrangling, Data Visualization, Statistical Analysis, A/B Testing, ANOVA Testing, Hypothesis Testing | Pandas, NumPy, SciPy, statsmodels, Matplotlib, Seaborn | A fast-food chain has added a new menu item, and it is currently undecided about three possible marketing campaigns for its new food product. This analysis conducts an A/B test to find the optimal marketing campaign to see if it is worth adding to the legacy menu. |
| :shopping:[Customer Shopping Behavior Analysis](https://github.com/jasondo-da/shopping_behavior_analysis) | Data Cleaning, Data Wrangling, Data Mining, Data Visualization, Exploratory Data Analysis, Customer Analysis, Geographic Information Systems | Pandas, Matplotlib, Seaborn, Folium, GeoPy, requests | The marketing team from a clothing apparel business is asking for recommendations on current customer behavior, improving the business processes, and growing the customer base. |
