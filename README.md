...
| :computer:[Canadian Data Science Jobs Analysis](https://github.com/jasondo-da/Canadian_Data_Analyst_Online_Job_Posting_Analysis) | Data Cleaning, Data Wrangling, Data Visualization, Exploratory Data Analysis (EDA) | Pandas, NumPy, Folium, Matplotlib, Seaborn, collection, GeoPy, requests | In Process |
